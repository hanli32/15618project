...
//     cusp::identity_operator<ValueType, MemorySpace> M(d_A.num_rows, d_A.num_rows);
...
//    check_routine(devID);
    ...
    cusparse_cg();
    double cusparse_time = CycleTimer::currentSeconds() - startTime;
    startTime = CycleTimer::currentSeconds();
    // cusp_cg(A);
    // double cusp_time = CycleTimer::currentSeconds() - startTime;
